...
do
    ...
    python bin/dataset_norman2019_k562.py perfect mlper1 0 --n-acquire 1000 --seed $seed >> norman_mlper1.log 2>&1
    ...
    echo -e "Norman Seed:\t"$seed >> norman_linear.log
    python bin/dataset_norman2019_k562.py perfect linear 0 --n-acquire 1000 --seed $seed >> norman_linear.log 2>&1
done
