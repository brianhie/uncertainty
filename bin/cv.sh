...
do
    ...
    export CUDA_VISIBLE_DEVICES=0
    python bin/train_davis2011kinase.py dmlper1 --seed $i >> train_davis2011kinase_dmlper1.log 2>&1 &
    ...
    python bin/train_davis2011kinase.py dhybrid --seed $i >> train_davis2011kinase_dhybrid.log 2>&1 &

    wait
done

#source activate cmfrec
#for i in {0..4}
#do
